...
class TransactionalUpsertHotelCapacityUseCaseTest {

    @Mock
    private UpsertHotelCapacityUseCase delegate;

    private TransactionalUpsertHotelCapacityUseCase useCase;

    private static final long HOTEL_ID = 1L;
    private static final long CAPACITY = 150L;

    @BeforeEach
    void setUp() {
        useCase = new TransactionalUpsertHotelCapacityUseCase(delegate);
    }
